...
public class OYDate extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(View view) {
        switch(view.getId()){
            case R.id.dateFromBtn:{
                DatePickerDialog datePickerDialog = new DatePickerDialog(OYDate.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
