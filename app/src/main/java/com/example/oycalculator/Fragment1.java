package com.example.oycalculator;
...
public class Fragment1 extends Fragment {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()){
            ...
            case R.id.DATE:{
                Intent intent = new Intent(getActivity(),OYDate.class);
    ...
    class btnEqualListener implements  View.OnClickListener{
        ...
        public Double ezCalculate(double x,double y,String operator){
            if(operator.equals("+"))
                ...
                if (y == 0)
                    Toast.makeText(getActivity(),"除数不可为0",Toast.LENGTH_SHORT).show();
                return 0.0;
            }
            return 0.0;
        }
        ...
        public void onClick(View view) {
            ...
            if(isSymbol(end)){
                ...
                if (Double.parseDouble(num) < 0) {
                    Toast.makeText(getActivity(),"负数不可开平方根",Toast.LENGTH_SHORT).show();
                } else {
